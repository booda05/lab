...
<body>
	...
	<div>
		<p class="meuilleur">Nous Sélectionnons le meuilleur pour votre rongeur</p>
		...
		<div class="divproduits">
			...
			<div style="grid-area: produit2;border-radius: 20px;box-shadow:1px 1px 1px 1px grey;width:35vw;">
				<a href="produit_chien2.php">
					...
					<div style="text-align:center;">
						<p> <span class="txt1"> RONGEUR </span> <br>
							<span class="txt2"><a href="" class="txt2">Royal canin Berger Allemand 16KG </a></span>
						</p>
